    ...
    return (
        <>
            <div>
                ...
                <h2 className="text-white" style={{marginBottom: '50px'}}>Газар хөдлөлт : 2020 он 6 сар - 2021 он 5 сар <br/> Нийт: {count}</h2>
                <div className="mapdiv">
                    <svg height="483" width="1000" xmlns="http://www.w3.org/2000/svg">
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Баян-Өлгий аймаг Нийт газар хөдлөлт: 0</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                <rect rx="8"></rect>
                                <text x="10" y="20">Дорноговь аймаг Нийт газар хөдлөлт: 1</text>
                        ...
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Хэнтий аймаг Нийт газар хөдлөлт: 0</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Архангай аймаг Нийт газар хөдлөлт: 0</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Баянхонгор аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                        ...
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Булган аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Орхон аймаг Нийт газар хөдлөлт: 0</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Дундговь аймаг Нийт газар хөдлөлт: 2</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Сэлэнгэ аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Өвөрхангай аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Дархан-Уул аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Төв аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Говьсүмбэр аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                        <a xlinkHref="#">
                            <g>
                        ...
                        <a xlinkHref="#">
                            <g>
                                ...
                                <rect rx="8"></rect>
                                <text x="10" y="20">Сүхбаатар аймаг Нийт газар хөдлөлт: 1</text>
                            </g>
                        </a>
                ...
                <input id="search" type="text" placeholder="Хайх..." onChange={(event) => {
