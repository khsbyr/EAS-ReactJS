...
function Dornod(props) {
    ...
    const [searchTerm, setSearchTerm] = useState("Дорнод");
    ...
    return (
        <>
            <div>
                ...
                <h2 className="text-white" style={{marginBottom: '50px'}}>Дорнод аймаг</h2>
